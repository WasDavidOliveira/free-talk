...
export class ConversationMessagesController {
  index = catchAsync(
    async (req: Request<ConversationParamsInput, {}, {}, PaginationInput>, res: Response) => {
  ...
  show = catchAsync(
    async (req: Request<MessageParamsInput>, res: Response) => {
      const userId = req.userId;
  ...
  create = catchAsync(
    async (req: Request<ConversationParamsInput, {}, CreateMessageInput>, res: Response) => {
      const userId = req.userId;
      const { conversationId } = req.params;
  ...
  update = catchAsync(
    async (req: Request<MessageParamsInput, {}, UpdateMessageInput>, res: Response) => {
      const userId = req.userId;
      const { conversationId, messageId } = req.params;
      const messageData = req.body;
  ...
  markAsRead = catchAsync(
    async (req: Request<ConversationParamsInput, {}, MarkAsReadInput>, res: Response) => {
      const userId = req.userId;
      const { conversationId } = req.params;
  ...
  getUnreadCount = catchAsync(
    async (req: Request<ConversationParamsInput>, res: Response) => {
      const userId = req.userId;
      const { conversationId } = req.params;
